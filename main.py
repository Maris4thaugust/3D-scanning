...
def main():
    ...
    TargetCloud_1_Filterd = NoiseRemoving(TargetCloud_1,30,VoxelSize*1.5,5)
    ...
    TargetCloud_2_Filterd = NoiseRemoving(TargetCloud_2,30,VoxelSize*1.5,5)
    ...
    TargetCloud_3_Filterd = NoiseRemoving(TargetCloud_3,30,VoxelSize*1.5,5)
    ...
    for i in range(1,35): 
        ...
        Pcd_Filter = NoiseRemoving(Pcd,0,VoxelSize*1.5,5)
    ...
    o3d.io.write_point_cloud(f"{Resultfolder}/FinalResult.ply", FinalResult)

if __name__ == "__main__":
    main()
    Target = o3d.io.read_point_cloud(f"Result/result_7/TargetCloud_1.ply")
